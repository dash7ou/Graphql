...
var getUsers = (0, _apolloBoost.gql)(_templateObject()); //posts schema

var getPosts = (0, _apolloBoost.gql)(_templateObject2()); // get user and add to html
...
client.query({
  ...
  posts.forEach(function (post) {
    ...
    var postAuthor = document.createElement("h4");
